...
- (void)viewDidLoad {
    ...
    _massTextField = [[UITextField alloc] initWithFrame:CGRectMake(50, 260, 320, 45)];
    ...
    _userTextField = [[UITextField alloc] initWithFrame:CGRectMake(50, 320, 320, 45)];
    ...
    _passTextField = [[UITextField alloc] initWithFrame:CGRectMake(50, 380, 320, 45)];
    ...
    _btn.frame = CGRectMake(150, 500, 140, 50);
