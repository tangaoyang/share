...
- (void)layoutSubviews {
    ...
    _iimageView.frame = CGRectMake(40, 10, 50, 50);
    
    _nameLabel.frame = CGRectMake(115, 14, 100, 28);
    _nameLabel.font = [UIFont systemFontOfSize:18];
    
    _contentLabel.frame = CGRectMake(115, 40, 220, 25);
    _contentLabel.font = [UIFont systemFontOfSize:15];
    _contentLabel.textColor = [UIColor colorWithRed:0.05 green:0.4 blue:0.74 alpha:1.0];
    
    _timeLabel.textColor = [UIColor grayColor];
    _timeLabel.font = [UIFont systemFontOfSize:10];
    _timeLabel.frame = CGRectMake(344, 10, 70, 10);
