...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if(tableView.tag == 111){
        UpTableViewCell *cell1 = [_tableView1 dequeueReusableCellWithIdentifier:@"111"];
        
        NSArray *nameArr = @[@"理想", @"晚安", @"看星星吗", @"诗", @"好天气"];
        NSArray *writerArr = @[@"share小孔", @"shareDT", @"share97", @"share小海", @"share因子"];
        NSArray *timeArr = @[@"12分钟前", @"13分钟前", @"1小时前" ,@"2小时前", @"5小时前"];
        ...
        UpTableViewCell *cell2 = [_tableView2 dequeueReusableCellWithIdentifier:@"222"];
        ...
        UpTableViewCell *cell3 = [_tableView3 dequeueReusableCellWithIdentifier:@"333"];
        ...
        cell3.contentLabel.text = contentArr[indexPath.row];
