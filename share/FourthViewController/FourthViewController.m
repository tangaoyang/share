...
- (void)viewDidLoad {
    ...
    [_tableView registerClass:[TAYFourthTableViewCell class] forCellReuseIdentifier:@"444"];
    
}

- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    
    TAYFourthTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"444" forIndexPath:indexPath];
    
    if(!cell) {
        TAYFourthTableViewCell *cell = [[TAYFourthTableViewCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"444"];
