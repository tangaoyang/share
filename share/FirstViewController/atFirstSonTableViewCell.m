...
- (void)layoutSubviews {
    ...
    _timeLabel.frame = CGRectMake(355, 15, 50, 15);
    
    _zanImageView.frame = CGRectMake(275, 50, 15, 15);
    
    _zanLabel.frame = CGRectMake(295, 50, 30, 15);
    
    _yanImageView.frame = CGRectMake(325, 50, 20, 15);
    
    _yanLabel.frame = CGRectMake(350, 50, 30, 15);
    
    _lineImageView.frame = CGRectMake(370, 50, 15, 15);
    
    _lineLabel.frame = CGRectMake(388, 50, 30, 15);
